...
const Contacts = () => {
    return (
        <section className='flex-col align-bottom space-y-1.5 p-1 w-full'>
            <p className='text-xl flex items-center font-semibold pb-2'>
